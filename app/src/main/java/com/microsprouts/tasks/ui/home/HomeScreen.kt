...
import com.microsprouts.tasks.ui.settings.LicensesScreen
import com.microsprouts.tasks.ui.settings.SettingsScreen
import com.microsprouts.tasks.ui.settings.TermsOfServiceScreen
...
fun HomeScreen(
    ...
    var currentScreen by remember { mutableStateOf("home") } // "home", "settings", "terms", or "licenses"
    ...
    when (currentScreen) {
        ...
        "settings" -> {
            SettingsScreen(
                ...
                onClearData = { viewModel.clearAllTasks() },
