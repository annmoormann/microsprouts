package com.microsprouts.tasks.util
        ...
        for (i in 0 until tasksArray.length()) {
            ...
            database.taskDao().insertTaskRaw(
                Task(
                    ...
                    currentList = com.microsprouts.tasks.data.entity.TaskList.valueOf(obj.getString("currentList")),
                    isRecurring = obj.getBoolean("isRecurring"),
                    intervalDays = obj.getInt("intervalDays"),
                    recurrenceBehavior = com.microsprouts.tasks.data.entity.RecurrenceBehavior.valueOf(obj.getString("recurrenceBehavior")),
                    lastGeneratedTimestamp = obj.getLong("lastGeneratedTimestamp"),
                    recurrenceUnit = com.microsprouts.tasks.data.entity.RecurrenceUnit.valueOf(obj.getString("recurrenceUnit")),
                    intervalValue = obj.getInt("intervalValue"),
                    monthlyRuleType = com.microsprouts.tasks.data.entity.MonthlyRuleType.valueOf(obj.getString("monthlyRuleType")),
                    monthlyDayOfMonth = obj.getInt("monthlyDayOfMonth"),
                    yearlyRuleType = com.microsprouts.tasks.data.entity.YearlyRuleType.valueOf(obj.getString("yearlyRuleType")),
